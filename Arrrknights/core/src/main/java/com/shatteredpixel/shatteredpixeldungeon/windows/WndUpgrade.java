    ...
    public WndUpgrade( Item upgrader, Item toUpgrade, boolean force){
        ...
        if (toUpgrade instanceof Armor){
            ...
            bottom = fillFields(Messages.get(this, "blocking"),
                    ...
                    bottom);
        } else if (toUpgrade instanceof MeleeWeapon.BlockingWeapon){
            MeleeWeapon.BlockingWeapon blockingItem = (MeleeWeapon.BlockingWeapon) toUpgrade;
            bottom = fillFields(Messages.get(this, "blocking"),
                    0 + "-" + blockingItem.DRMax(levelFrom),
                    0 + "-" + blockingItem.DRMax(levelTo),
                    bottom);
        }
