                    ...
                    if (mob instanceof SkinModel) {
                        ...
                        switch (a) {
                            ...
                            case 18: // 제껄룩 스킨
                                ...
                                break;
                            case 19:
                                if(!Badges.isUnlocked(Badges.Badge.SKIN_KAYOKO)) {Badges.validatekayokoskin();}
                                sprite.showStatus( CharSprite.POSITIVE, Messages.get(this, "hi"));
                                break;
                            case 20:
                                if(!Badges.isUnlocked(Badges.Badge.SKIN_NEURO)) {Badges.validateNeuroSkin();}
                                sprite.showStatus( CharSprite.POSITIVE, Messages.get(this, "hi"));
                                break;
                            case 21:
                                if(!Badges.isUnlocked(Badges.Badge.SKIN_WISADEL)) {Badges.validateWisadelSkin();}
                                sprite.showStatus( CharSprite.POSITIVE, Messages.get(this, "hi"));
                                break;
                            case 22:
                            ...
                            case 23:
                                ...
                                break;
                            case 24:
                                if(!Badges.isUnlocked(Badges.Badge.SKIN_NEURO_ANGEL)) {Badges.validateNeuroAngelSkin();}
                                sprite.showStatus( CharSprite.POSITIVE, Messages.get(this, "hi"));
                                break;
                            case 25:
                                if(!Badges.isUnlocked(Badges.Badge.SKIN_NEURO_CAT)) {Badges.validateNeuroCatSkin();}
                                sprite.showStatus( CharSprite.POSITIVE, Messages.get(this, "hi"));
                                break;
                            case 26:
                                if(!Badges.isUnlocked(Badges.Badge.SKIN_NEURO_JOKER)) {Badges.validateNeuroJokerSkin();}
                                sprite.showStatus( CharSprite.POSITIVE, Messages.get(this, "hi"));
                                break;
                            case 27:
